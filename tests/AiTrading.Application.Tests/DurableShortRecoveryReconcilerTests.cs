...
public sealed class DurableShortRecoveryReconcilerTests
{
    ...
    public void Consistent_full_cover_state_reconciles()
    {
        ...
        var covers = new[]
        {
            new DurableShortCoverState(Guid.NewGuid(), positionId, "cover-1", 92m, 5, 40m, 1, created.AddMinutes(1))
        };
    ...
    public void Partial_cover_state_reconciles()
    {
        ...
        var covers = new[]
        {
            new DurableShortCoverState(Guid.NewGuid(), positionId, "cover-1", 96m, 4, 16m, 1, created.AddMinutes(1))
        };
