...
public partial class PredictionEvaluation : Migration
{
 protected override void Up(MigrationBuilder m)
 {
  ...
  m.CreateTable(name:"prediction_outcomes",columns:t=>new{PredictionId=t.Column<Guid>(type:"char(36)",nullable:false),ActualReturn=t.Column<decimal>(type:"decimal(20,8)",precision:20,scale:8,nullable:false),OutcomeTimestamp=t.Column<DateTimeOffset>(type:"datetime(6)",nullable:false)},constraints:t=>t.PrimaryKey("PK_prediction_outcomes",x=>x.PredictionId));
  ...
  m.AddForeignKey(name:"FK_prediction_outcomes_predictions_PredictionId",table:"prediction_outcomes",column:"PredictionId",principalTable:"predictions",principalColumn:"Id",onDelete:ReferentialAction.Cascade);
 }
